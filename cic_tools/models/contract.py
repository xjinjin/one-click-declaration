...
class Contract(models.Model):
    ...
    order_line = fields.One2many('contract.clause.line', 'order_id', string='Order Lines', states={'cancel': [('readonly', True)], 'done': [('readonly', True)]}, copy=True)
    ...
    def copy(self, default=None):
        new_po = super(Contract, self).copy(default=default)
    ...
    def message_post(self, **kwargs):
        ...
        return super(Contract, self.with_context(mail_post_autofollow=True)).message_post(**kwargs)
...
class ContractClauseLine(models.Model):
    _name = 'contract.clause.line'
